...
class BaseMiner(AbstractMiner):
    ...
    >>> from sberpm.miners import BaseMiner
    >>>
    >>> # Create data_holder
    >>> df = pd.DataFrame({
    ...     'id_column': [1, 1, 2],
    ...
    def __init__(self, data_holder):
        ...
        warnings.warn('BaseMiner will be removed in version 1.4.0, use CausalMiner instead (sberpm.miners.CausalMiner).'
                      , FutureWarning)
